...
const MODEL_DESCRIPTIONS: Record<string, string> = {
  ...
  "inception/mercury-2": "Fast inference model. Good balance of speed and capability for data work.",
  "kwaipilot/kat-coder-pro": "Code-focused model. Good at writing and debugging R code at a low cost.",
